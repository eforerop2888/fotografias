...
(function() {
  ...
  resizeImage = function() {
    ...
    imageOri = $('.masonry-item').find('img[src$="' + image.src + '"]').parent().parent().prev().html();
    $('#fullsized_favoritegallery').html(imageOri);
    if (image.ratio == null) {
  ...
  closeViewer = function() {
  	//Play Gallery
    clearInterval($.cookie("intervalPlay"));
    $('#fullsized_stopgallery').replaceWith('<a id="fullsized_playgallery" href="#playgallery"><i class="fa fa-play-circle fa-2x" aria-hidden="true"></i></a>');
  ...
  prepareCurtain = function() {
    if (options.loadOptions) {
      ...
      if (options.closeButton) {
        $image_holder.append('<a id="fullsized_close" href="#close"><i class="fa fa-times fa-2x" aria-hidden="true"></i></a>');
      ...
      if (options.fullscreenButton && hasFullscreenSupport()) {
        $image_holder.append('<a id="fullsized_fullscreen" href="#fullscreen"><i class="fa fa-expand fa-2x" aria-hidden="true"></i></a>');
      ...
      //Play bottom
      $image_holder.append('<a id="fullsized_playgallery" href="#playgallery"><i class="fa fa-play-circle fa-2x" aria-hidden="true"></i></a>');
   
      //Download bottom
      $image_holder.append('<a id="fullsized_downloadgallery" href="#downloadgallery"><i class="fa fa-download fa-2x" aria-hidden="true"></i></a>');

      //Favorite bottom
      $image_holder.append('<div id="fullsized_favoritegallery" href="#favoritegallery"></div>');
    }
  ...
  $.fn.fullsizable = function(opts) {
    options = $.extend({
      ...
      reloadOnOpen: false,
      loop: false,
      loadOptions : true //Custom option
    }, opts || {});
    prepareCurtain();
    if (options.preload) {
      makeFullsizable();
  ...
  /*togglePlaygallery = function() {
    interval = setInterval($('#fullsized_go_next').click(), 6000);
  };*/
